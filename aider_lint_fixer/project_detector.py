...
class ProjectDetector:
    ...
    LINT_CONFIGS = {
        ...
        'prettier': ['.prettierrc', '.prettierrc.js', '.prettierrc.json', '.prettierrc.yml', 'package.json'],
        'tslint': ['tslint.json'],
        ...
        # Ansible linters
        'ansible-lint': ['.ansible-lint', '.ansible-lint.yml', '.ansible-lint.yaml', 'ansible-lint.yml', 'ansible-lint.yaml']
    }
    ...
    def _scan_directory(self, directory: Path, project_info: ProjectInfo, max_depth: int = 10) -> None:
    ...
    def _is_config_file(self, file_path: Path) -> bool:
        ...
        return (file_path.suffix in config_extensions or 
                file_path.name in config_names or
