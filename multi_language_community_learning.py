...
"""
    ...
    return {"title": f"Enhancement: Improve {ecosystem.language.value} classification", "body": "Generic template"}
    ...
    for language, data in examples.items():
        ...
        if data["real_world_scenarios"]:
            ...
            for scenario in data["real_world_scenarios"][:2]:
                ...
                print(f"     Success Rate: {scenario['success_rate']}, Fix Time: {scenario['fix_time']}")
