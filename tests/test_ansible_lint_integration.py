...
"""
    ...
    def _test_modular_implementation(self):
        ...
        self.assertGreater(len(result.errors), 0, "Should detect lint errors in problematic playbook")
    ...
    def test_ansible_lint_with_aider_integration(self, mock_subprocess, mock_find_aider):
        ...
        if len(lint_result.errors) > 0:
            ...
            fix_result = integration._run_aider_fix('playbook.yml', lint_result.errors[:3])  # Test with first 3 errors
