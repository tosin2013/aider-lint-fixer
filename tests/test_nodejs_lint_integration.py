  ...
  "main": "test.js"
    ...
    def test_eslint_detects_errors(self):
        ...
        try:
            ...
            print(f"✅ ESLint detected {len(result.errors)} errors, {len(result.warnings)} warnings")
    ...
    def test_jshint_detects_errors(self):
        ...
        try:
            ...
            self.assertTrue(any('semicolon' in msg.lower() for msg in error_messages), 
                          "Should detect missing semicolons")
            
            print(f"✅ JSHint detected {len(result.errors)} errors, {len(result.warnings)} warnings")
    ...
    def test_prettier_detects_formatting_issues(self):
        ...
        try:
            ...
            self.assertTrue(any('style' in msg.lower() or 'format' in msg.lower() 
                              for msg in warning_messages), 
                          "Should detect formatting issues")
            
            print(f"✅ Prettier detected {len(result.errors)} errors, {len(result.warnings)} warnings")
    ...
    def test_nodejs_profile_support(self):
        ...
        try:
            ...
            print(f"✅ Profile support working: basic={len(result_basic.errors)} errors, strict={len(result_strict.errors)} errors")
