...
def test_progress_tracker_basic_functionality():
    ...
    try:
        ...
        assert not small_tracker.is_large_project, "50 errors should not be considered large project"
...
def test_progress_summary():
    ...
    try:
        ...
        expected_keys = [
            "session_id", "elapsed_time", "total_files", "processed_files",
            "total_errors", "processed_errors", "fixed_errors", "failed_errors",
            "success_rate", "current_stage", "is_large_project"
        ]
