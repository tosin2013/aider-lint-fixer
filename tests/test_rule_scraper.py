...
from aider_lint_fixer.rule_scraper import RuleScraper, RuleInfo, scrape_and_update_knowledge_base
...
class TestRuleScraper:
    ...
    def test_ansible_lint_parsing(self, mock_get):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            rules = scraper._scrape_url("https://ansible-lint.readthedocs.io/rules/yaml/", "ansible-lint")
    ...
    def test_flake8_parsing(self, mock_get):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            rules = scraper._scrape_url("https://flake8.pycqa.org/en/latest/user/error-codes.html", "flake8")
    ...
    def test_error_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            rules = scraper._scrape_url("https://invalid-url-that-does-not-exist.com", "test-linter")
...
class TestScrapingIntegration:
    ...
    def test_scraped_rules_file_format(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            required_fields = ["rule_id", "category", "auto_fixable", "complexity", 
                             "description", "fix_strategy", "source_url"]
